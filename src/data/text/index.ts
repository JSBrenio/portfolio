// Re-export all content functions for easy importing
export { getHomeContent, type HomeContent } from './homeContent';
export { getAboutContent, type AboutContent } from './aboutContent';
